...
# The four-view scene first, because it is the one every measured figure in
# the README belongs to. The twelve-view variant renders the whole banner and
# takes three times as long for a picture, not a better number.
SCENES = [WAREHOUSE_014, WAREHOUSE_014_FULL]
