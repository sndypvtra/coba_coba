...
the repository root and all of them imported it. A copy of exactly what this one
case needs lives here instead, so the folder can be lifted into a repository of
its own and still run.
